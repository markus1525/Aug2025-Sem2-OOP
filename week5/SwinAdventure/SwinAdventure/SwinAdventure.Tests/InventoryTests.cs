...
namespace SwinAdventure.Tests
{
    ...
    public class InventoryTests
    {
        ...
        public void TestItemList()
        {
            ...
            // Assert
            Assert.That(itemList.Contains("\ta bronze sword (sword)"), Is.True, "Item list should contain tabbed sword description");
            Assert.That(itemList.Contains("\ta red gem (gem)"), Is.True, "Item list should contain tabbed gem description");
        }
    }
}