...
namespace SwinAdventure.Tests
{
    ...
    public class InventoryTests
    {
        ...
        public void TestFetchItem()
        {
            ...
            Assert.That(fetchedSword, Is.SameAs(_testItem1));
            Assert.That(fetchedGem, Is.SameAs(_testItem2));
        ...
        public void TestTakeItem()
        {
            ...
            Assert.That(takenSword, Is.SameAs(_testItem1));
            Assert.That(takenGem, Is.SameAs(_testItem2));
        ...
        public void TestItemList()
        {
            ...
            // Assert
            Assert.That(itemList.Contains("The List of items in this inventory:\n"));
            Assert.That(itemList.Contains("\ta bronze sword (sword)"));
            Assert.That(itemList.Contains("\ta red gem (gem)"));   
        }
    }
}